...
d3.json("http://54.187.35.158/mobrise/v0/reservations/cars", function (data) {
    ...
    "July", "August", "September", "October", "November", "December" ];
            ...
            data.forEach(function (e) {
                ...
                e.dd_dep = dateFormat.parse(e.car_pickup_date);
            ...
            var daysBetweenSum = daysBetweenDim.group().reduceSum(function (d) {
                return (d.car_rental_days * d.car_daily_rate)/1000;   
            });
...
//					.ticks(4);
            ...
            dc.dataTable(".dc-data-table")
                    ...
                    .columns([
                        ...
                        function (d) {
                            return "$" + numberFormat(d.car_rental_days * d.car_daily_rate);
                        },
                        function (d) {
                            return d.car_chain_name;
                        },
