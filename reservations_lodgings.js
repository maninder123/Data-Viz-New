...
d3.json("http://54.187.35.158/mobrise/v0/reservations/lodgings", function (data) {
$.unblockUI();
    dataHandle = data;
			var debug = true;
    ...
    "July", "August", "September", "October", "November", "December" ];
            ...
            data.forEach(function (e) {
                ...
                e.dd_dep = dateFormat.parse(e.checkin_date);
            ...
            var daysBetweenSum = daysBetweenDim.group().reduceSum(function (d) {
                return (d.number_of_room_nights * d.daily_rate)/1000;   
            });
...
//					.ticks(4);
            ...
            dc.dataTable(".dc-data-table")
                    ...
                    .columns([
                        ...
                        function (d) {
                            return "$" + numberFormat(d.number_of_room_nights * d.daily_rate);
                        },
                        function (d) {
                            return d.hotel_chain_name;
                        },
