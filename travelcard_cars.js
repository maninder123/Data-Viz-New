...
var bureauChart = dc.pieChart("#bureau-chart");
...
d3.json("http://54.187.35.158/mobrise/v0/travelcard/cars", function (data) {
$.unblockUI();
    dataHandle = data;
			var debug = true;
